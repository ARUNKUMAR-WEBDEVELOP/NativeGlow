  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/50 p-3 sm:items-center">
      <div className="w-full max-w-sm rounded-2xl border border-zinc-200 bg-white p-5 shadow-lg sm:p-6">
        <h2 className="text-xl font-bold text-zinc-900">Submit Discount</h2>
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row">
          ...
          <button
            ...
            onClick={handleApply}
            disabled={loading}
            className="flex-1 rounded-lg bg-emerald-700 px-3 py-2 text-sm font-semibold text-white transition hover:bg-emerald-800 disabled:opacity-50"
          >
