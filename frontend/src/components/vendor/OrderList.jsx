              ...
              <article key={order.id} className="rounded-3xl border border-zinc-200 bg-white p-4 shadow-sm sm:p-5">
                ...
                <div className="mt-4 grid gap-3 lg:grid-cols-[1.2fr_0.8fr]">
                  ...
                  <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
                    ...
                    <div className="rounded-2xl border border-zinc-200 bg-white px-3 py-3 text-sm">
                      <p className="text-xs font-semibold uppercase tracking-wide text-zinc-500">Payment Ref</p>
                      <p className="mt-1 text-sm font-semibold text-zinc-900">{order.payment_reference || 'N/A'}</p>
                    </div>
                  </div>
                </div>
