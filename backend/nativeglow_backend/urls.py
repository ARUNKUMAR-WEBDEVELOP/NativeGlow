...
from vendors.views import VendorRegisterView, VendorLoginView, VendorProfileView, VendorActivateView, VendorApprovalStatusView, VendorBrandAssetUploadView
...
urlpatterns = [
    ...
    path('api/vendor/brand-assets/upload/', VendorBrandAssetUploadView.as_view(), name='vendor-brand-asset-upload-public'),
